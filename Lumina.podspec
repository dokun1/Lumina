Pod::Spec.new do |s|
  ...
  s.source_files = ["Lumina/Lumina/Camera/*.swift", "Lumina/Lumina/Camera/Extensions/*.swift", "Lumina/Lumina/Camera/Extensions/Delegates/*.swift", "Lumina/Lumina/UI/*.swift", "Lumina/Lumina/UI/Extensions/*.swift", "Lumina/Lumina/UI/Extensions/Delegates/*.swift"]
